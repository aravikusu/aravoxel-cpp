...
void TestScene::init(Settings *settingsRef) {
...
void TestScene::keyInput(GLFWwindow *window, const float deltaTime) {
    camera.keyboardInput(window, deltaTime);
}

void TestScene::mouseInput(const double xOffset, const double yOffset) {
